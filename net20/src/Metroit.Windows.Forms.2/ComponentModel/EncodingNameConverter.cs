...
namespace Metroit.Windows.Forms.ComponentModel
{
    ...
    public class EncodingNameConverter : TypeConverter
    {
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
        {
            ...
            var eiList = Encoding.GetEncodings();
            foreach (var ei in eiList)
            {
                var encoding = ei.GetEncoding();
                if (encoding.WebName + " | " + encoding.EncodingName == s)
                {
                    return encoding;
                }
            }
        ...
        public override StandardValuesCollection GetStandardValues(ITypeDescriptorContext context)
        {
            ...
            var eiList = Encoding.GetEncodings();
            Array.Sort(eiList, (a, b) => a.GetEncoding().WebName.CompareTo(b.GetEncoding().WebName));
            foreach (var ei in eiList)
            {
