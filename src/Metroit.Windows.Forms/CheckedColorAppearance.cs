...
namespace Metroit.Windows.Forms
{
    ...
    public class CheckedColorAppearance
    {
        ...
        internal CheckedColorAppearance(CheckBox owner, string key, IReadOnlyList<PropertyDefaultController> defaultControllers)
        {
            Owner = owner;
            Key = key;
