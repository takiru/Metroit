...
|----------------------|------|------------------|
|Metroit               |[![NuGet](https://img.shields.io/badge/nuget-v3.0.0-blue.svg)](https://www.nuget.org/packages/Metroit/) | `net8.0` `net9.0` `netstandard2.0` `netstandard2.1` `net45` |
...
|Metroit.Windows.Forms |[![NuGet](https://img.shields.io/badge/nuget-v3.1.3-blue.svg)](https://www.nuget.org/packages/Metroit.Windows.Forms/) | `net6.0-windows` `net8.0-windows` `net462` |
