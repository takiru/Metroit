...
|Metroit.Windows.Forms |[![NuGet](https://img.shields.io/badge/nuget-v3.5.0-blue.svg)](https://www.nuget.org/packages/Metroit.Windows.Forms/) | `net6.0-windows` `net8.0-windows` `net462` |
